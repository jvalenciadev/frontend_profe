    ...
    return (
        <div className="space-y-10 max-w-[1600px] mx-auto p-6 md:p-10">
            ...
            {filteredModules.length === 0 ? (
                <div className="p-12 text-center space-y-3 bg-card rounded-3xl border border-border/50 max-w-lg mx-auto">
                    <ShieldAlert className="w-12 h-12 text-amber-500 mx-auto" />
                    <h3 className="text-base font-black uppercase text-foreground">Sin Funciones Habilitadas</h3>
                    <p className="text-xs text-muted-foreground">
                        Tu rol actual no cuenta con permisos asignados para los submódulos de Evaluación. Si requieres acceso a Periodos, Cuestionarios, Asignaciones o Evaluar Personal, contacta al Administrador.
                    </p>
                </div>
            ) : (
